    ...
    return (
      <div style={{ width: "100%" }}>
        ...
        >
          ...
          {bulkMode && (
            <span
              style={{ fontSize: "1.15rem", fontWeight: 700, color: "#EA4D4E" }} // was 0.95rem
            >
              Enter QTY.
            </span>
          )}
                ...
                {bulkMode ? (
                  ...
                  <input
                    ...
                    style={{
                      ...
                      textAlign: "center",
                      fontSize: "clamp(1.1rem, 1.5vw, 1.35rem)", // was clamp(0.95rem, 1.3vw, 1.15rem)
                      fontWeight: 700,
                      color: "#050404",
                      outline: "none",
                      background: "#FFFFFF",
                  ...
                  <>
                    ...
                    <span
                      style={{
                        minWidth: "32px", // was 28px
                        textAlign: "center",
                        fontSize: "1.35rem", // was 1.1rem
                        fontWeight: 700,
                        color: "#050404",
                      }}
                    >
